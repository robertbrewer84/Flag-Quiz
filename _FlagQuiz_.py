...
# Flag Quiz is, not surprisingly, a flag quiz where users may select a difficulty level and progress through
# 8 questions, gaining points for each question they answer correctly. Once they have completed the quiz they
# will enter their name and their score will be added to a high scores table.

# I believe this program satsfies the requirements for an advanced higher project and have therefore included
# in the commentary where this has been achieved.
...
def loadhighscores():
    ...
    progfile = open("highscores.txt","r")
    reader = csv.reader(progfile)
